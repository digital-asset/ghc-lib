...
buildDists
  ...
  do
    ...
    Just pathNoStack <- lookupEnv "PATH_NO_STACK"
    ...
    setEnv "PATH" pathNoStack
    unsetEnv "GHC_PACKAGE_PATH"
    unsetEnv "GHC_ENVIRONMENT"
    Just path <- lookupEnv "PATH"
    whichGhc <- systemOutput_ "which ghc"
    whichCabal <- systemOutput_ "which cabal"
    ghcVersion <- systemOutput_ "ghc --version"
    cabalVersion <- systemOutput_ "cabal --version"
    putStrLn "----------------------------------"
    putStrLn $ "ghc: " ++ whichGhc
    putStrLn $ "ghc: " ++ whichCabal
    putStrLn $ "PATH: " ++ path
    putStrLn $ "ghc version: " ++ ghcVersion
    putStrLn $ "cabal version: " ++ cabalVersion
    putStrLn "----------------------------------"
